...
*   로그인 - "학생증" 발급 받기
*
*   AccessToken) (복도를 돌아다닐 때 보여주는) 1일짜리 학생증 (학생이 소지)
*   RefreshToken) 학생증 재발급 권한 기록 (교무실에 보관)
*
*   JWT 필터: JWTAuthenticationFilter) (복도에서) 학생증 검사를 하는 선도부
...
*
*   3) JwtAuthenticationFiler를 필터 체인에 추가
